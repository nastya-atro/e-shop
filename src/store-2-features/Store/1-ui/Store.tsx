...
import { productsSelector, limitPageSelector, isLoadingSelector, sortValueSelector, categoryProductsSelector } from './../2-bll/StoreSelector';
import { getProductsThunk, getSingleProductsThunk, getCategoryThunk, getCategoryProductsThunk } from './../2-bll/StoreReducer';
...
const Store: React.FC = () => {
    ...
    return (
        <div>
            ...
            {products ? products.map((p) =><div> <NavLink to={`/products/${p.id}`}><div key={p.id} >
